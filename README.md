...
$ repo init -u https://github.com/HashXperia/platform_manifest -b mm-6.0
```
...
Follow [This BuildScript](https://github.com/SonyAosp/vendor_google/blob/mm-6.0/build.sh)
